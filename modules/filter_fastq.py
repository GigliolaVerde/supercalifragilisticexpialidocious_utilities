...
def iterate_in_fastq(input_fastq: str) -> Iterator[Tuple[str, str, str, str]]:
    """
    ...
    Returns:
        Iterator yielding tuples of (seq_name, seq, plus, quality).
    """
...
def check_gc_content(
    ...
    Arguments:
        ...
        gc_bounds: integer or tuple with two numbers

    Returns:
        bool: True if GC content meets bounds

    Raises:
        ValueError: if GC-content bounds is not a tuple with two numbers
    """
...
def check_length(
    ...
    Arguments:
        seq: DNA/RNA sequence
        length_bounds: integer or tuple with two numbers

    Returns:
        bool: True if sequence length meets bounds

    Raises:
        ValueError: if length bounds are invalid
    """
...
def check_quality(quality: str, quality_threshold: int) -> bool:
    ...
    Arguments:
        quality: quality string from FASTQ
        quality_threshold: minimum average quality score

    Returns:
        bool: True if average quality meets threshold

    Raises:
        ValueError: if quality_threshold isn't a number
    """
